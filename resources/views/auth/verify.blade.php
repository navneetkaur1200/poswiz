                                ...
                                <div class="d-flex flex-column h-100">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted">Re-Password with {{Config::get('constants.AppnameGlobe') }}.</p>
                                        </div>
                                    ...
                                    <div class="mt-4 mt-md-5 text-center">
                                        <p class="mb-0">© <script>
                                            ...
                                            </script> {{Config::get('constants.AppnameGlobe') }}. Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                            Themesbrand</p>
                                    </div>
                                </div>
                            </div>
